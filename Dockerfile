...
RUN apt-get install -y supervisor wget openjdk-7-jdk openjdk-7-jre-headless python-pip && \
    ...
    tar -xzf kibana-4.3.1-linux-x64.tar.gz && mv kibana-4.3.1-linux-x64/* /opt/kibana/ && \
    rm -rf kibana-4.3.1-linux-x64 kibana-4.3.1-linux-x64.tar.gz elasticsearch-2.1.1.deb logstash_2.1.1-1_all.deb && \
